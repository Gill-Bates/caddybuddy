...
- See `tests/test_caddyfile_utils.py`, `test_caddyfile_parser.py`, `test_admin_targets.py`, `test_hidden_captcha.py`, `test_security_logging.py`, `test_parsing_utils.py`, `test_version_source.py`.
...
### External
- Mostly standard library (`re`, `ipaddress`, `hashlib`, `json`, `datetime`).
