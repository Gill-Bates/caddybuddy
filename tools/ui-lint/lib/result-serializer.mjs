...
export function serializeResultForOutput(result, { summaryPath, visualRegressionEnabled }) {
    ...
    return {
        ...
        toastExitVisible: metrics.toastExit?.present ? countItems(metrics.toastExit.offenders) : null,
        toastExitDetails: sanitizeDetails(metrics.toastExit?.offenders),
        reducedTransparencyBackdrops: metrics.reducedTransparencyBackdrop?.present
            ? countItems(metrics.reducedTransparencyBackdrop.offenders)
            : null,
        reducedTransparencyBackdropDetails: sanitizeDetails(metrics.reducedTransparencyBackdrop?.offenders),
        ...
        tableRowCount: metrics.managementTableDensity?.rowCount ?? null,
        tableMedianRowHeight: metrics.managementTableDensity?.medianRowHeightPx ?? null,
        tableMaxRowHeight: metrics.managementTableDensity?.maxRowHeightPx ?? null,
        tableRowsTooTall: countItems(metrics.managementTableDensity?.oversizedRows),
        tableControlSizes: countItems(metrics.tableRhythm?.controlSizeMismatches),
        tableControlSizeDetails: sanitizeDetails(metrics.tableRhythm?.controlSizeMismatches),
        tableToolbarHeights: countItems(metrics.tableRhythm?.toolbarHeightMismatches),
        tableToolbarHeightDetails: sanitizeDetails(metrics.tableRhythm?.toolbarHeightMismatches),
        tableActionGaps: countItems(metrics.tableRhythm?.actionGapMismatches),
        ...
        consoleDetails: sanitizeDetails(network.consoleEntries),
